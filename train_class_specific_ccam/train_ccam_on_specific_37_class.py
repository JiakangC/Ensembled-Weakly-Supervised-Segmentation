...
def train_class_model(class_name, data_dir, max_epoch=10, batch_size=32):
    ...
    # Training loop
    for epoch in range(max_epoch, desc=f"Training {class_name}"):
        running_loss = 0
        ...
        # Save model
        save_dir = os.path.join(root_dir, 'train_class_specific_ccam', 'model_saved' ,'class_specific_ccam')
...
if __name__ == "__main__":
    ...
    data_dir = os.path.join(root_dir, "data", "class_folders")  # Assumes images are in class-specific folders
